...
// const terserrPlugin = require('terser-webpack-plugin');
...
module.exports = {
    ...
    devServer:{
        ...
        devMiddleware:{
            // index specifies which file should be used when we open http://localhost:9000/ in the browser
            index:"hello-world.html",
            // writeToDisk tells webpack-dev-server to write the generated files on disk (by default it serves the files from memory)
            writeToDisk:true
        }
    },
    optimization:{
